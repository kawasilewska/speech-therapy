...
<!-- Wyświetlenie dostępnych gier na koncie osoby wspomaganej -->
<!DOCTYPE html>
<html lang="pl">
  <head>
  ...
  <body>
    ...
    <header id="header">
        ...
        <div class="row" id="b">
            <div class="small-12 medium-12 large-12 columns">
                <h5>Kliknięcie tytułu gry spowoduje jej pobranie</h5>
            </div>
        </div>
    </header>
    ...
    <div class="gameone">
        <div class="row">
            ...
            <div class="small-12 medium-7 large-8 columns">
                <h4><b><a href="files/Zgadnij_i_Lec.rar">Zgadnij i Leć (pobierz)</a></b></h4>
